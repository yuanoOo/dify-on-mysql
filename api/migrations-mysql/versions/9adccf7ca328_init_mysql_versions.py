...
Revision ID: 9adccf7ca328
Revises: 
Create Date: 2025-03-21 02:09:59.674636
...
def upgrade():
    ...
    sa.Column('id', models.types.StringUUID(), nullable=False),
    sa.Column('dataset_id', models.types.StringUUID(), nullable=False),
    sa.Column('keyword_table', mysql.LONGTEXT(), nullable=False),
    ...
    sa.Column('index_struct', mysql.LONGTEXT(), nullable=True),
    sa.Column('created_by', models.types.StringUUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_by', models.types.StringUUID(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    ...
    sa.Column('position', sa.Integer(), nullable=False),
    sa.Column('data_source_type', sa.String(length=255), nullable=False),
    sa.Column('data_source_info', mysql.LONGTEXT(), nullable=True),
    ...
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('encrypted_config', mysql.LONGTEXT(), nullable=True),
    sa.Column('enabled', sa.Boolean(), server_default=sa.text('true'), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    ...
    sa.Column('status', sa.String(length=255), nullable=False),
    sa.Column('custom_config', mysql.LONGTEXT(), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    ...
    sa.Column('process_data', mysql.LONGTEXT(), nullable=True),
    ...
    sa.Column('triggered_from', sa.String(length=255), nullable=False),
    sa.Column('version', sa.String(length=255), nullable=False),
    sa.Column('graph', mysql.LONGTEXT(), nullable=True),
    sa.Column('inputs', mysql.LONGTEXT(), nullable=True),
    sa.Column('status', sa.String(length=255), nullable=False),
    sa.Column('outputs', sa.Text(), nullable=True),
    sa.Column('error', sa.Text(), nullable=True),
    sa.Column('elapsed_time', sa.Float(), server_default=sa.text('0'), nullable=False),
    ...
    sa.Column('graph', mysql.LONGTEXT(), nullable=False),
    sa.Column('features', mysql.LONGTEXT(), nullable=False),
    sa.Column('created_by', models.types.StringUUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_by', models.types.StringUUID(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('environment_variables', mysql.LONGTEXT(), nullable=False),
    sa.Column('conversation_variables', mysql.LONGTEXT(), nullable=False),
